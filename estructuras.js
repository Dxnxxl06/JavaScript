...
switch (valor) {
    ...
    case 350000:
        ...
        break;
    default:
        console.log(`EL vehiculo tiene un SOAT COMPLETO de ${valor}`)
        break;
}
...
let marcas = [`Sushi Guayaba`,`Mike`,`Nigualan`,`Daniels`,`Ardidas`,`Arturo Casa`];
